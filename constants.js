...
module.exports = {
    ...
    RINKEBY_ARCHIVE_NODE_URL: `${process.env["ALCHEMY_RINKEBY_ENDPOINT"]}`,
    HOMESTEAD_ARCHIVE_NODE_URL: `${process.env["ALCHEMY_HOMESTEAD_ENDPOINT"]}`,
    XDAI_ARCHIVE_NODE_URL: "https://xdai-archive.blockscout.com",
