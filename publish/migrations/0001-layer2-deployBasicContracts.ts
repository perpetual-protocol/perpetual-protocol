...
const migration: MigrationDefinition = {
    getTasks: (context: MigrationContext) => [
        ...
        async (): Promise<void> => {
            ...
            await context.factory.create<InsuranceFund>(ContractName.InsuranceFund).deployUpgradableContract()
        },
        async (): Promise<void> => {
        ...
        async (): Promise<void> => {
            ...
            const clearingHouse = context.factory.create<ClearingHouse>(ContractName.ClearingHouse)
            const metaTxGateway = await context.factory.create<MetaTxGateway>(ContractName.MetaTxGateway).instance()
        ...
        async (): Promise<void> => {
            ...
            const clearingHouse = context.factory.create<ClearingHouse>(ContractName.ClearingHouse)
            const insuranceFund = await context.factory.create<InsuranceFund>(ContractName.InsuranceFund).instance()
        ...
        async (): Promise<void> => {
            ...
            const clearingHouse = await context.factory.create<ClearingHouse>(ContractName.ClearingHouse).instance()
            await (
        ...
        async (): Promise<void> => {
            ...
            const ammReaderContract = context.factory.create<AmmReader>(ContractName.AmmReader)
        ...
        async (): Promise<void> => {
            ...
            const clientBridgeContract = context.factory.create<ClientBridge>(ContractName.ClientBridge)
        ...
        async (): Promise<void> => {
            ...
            const l2PriceFeed = await context.factory.create<L2PriceFeed>(ContractName.L2PriceFeed).instance()
        ...
        async (): Promise<void> => {
            ...
            const amm = await context.factory.createAmm(AmmInstanceName.ETHUSDC).instance()
        ...
        async (): Promise<void> => {
            ...
            const insuranceFundContract = context.factory.create<InsuranceFund>(ContractName.InsuranceFund)
            const ammContract = context.factory.createAmm(AmmInstanceName.ETHUSDC)
        ...
        async (): Promise<void> => {
            ...
            const amm = await context.factory.createAmm(AmmInstanceName.BTCUSDC).instance()
            const { maxHoldingBaseAsset, openInterestNotionalCap } = context.deployConfig.legacyAmmConfigMap[
        ...
        async (): Promise<void> => {
            ...
            const insuranceFundContract = context.factory.create<InsuranceFund>(ContractName.InsuranceFund)
            const ammContract = context.factory.createAmm(AmmInstanceName.BTCUSDC)
            const insuranceFund = await insuranceFundContract.instance()
            await (await insuranceFund.addAmm(ammContract.address!)).wait(context.deployConfig.confirmations)
        },
        async (): Promise<void> => {
        ...
        async (): Promise<void> => {
            ...
            const ethUsdc = await context.factory.createAmm(AmmInstanceName.ETHUSDC).instance()
            await (await ethUsdc.setOpen(true)).wait(context.deployConfig.confirmations)
        },
        async (): Promise<void> => {
            console.log("opening Amm BTCUSDC...")
            const btcUsdc = await context.factory.createAmm(AmmInstanceName.BTCUSDC).instance()
        ...
        async (): Promise<void> => {
            ...
            const clientBridge = await context.factory.create<ClientBridge>(ContractName.ClientBridge).instance()
